...
File_or_Value : Input Excel/CSV File   | File Path    | -             | Determine the file path for the input Excel/CSV file.
File_or_Value : Input Value | Value | - | Value(s) to be written.
