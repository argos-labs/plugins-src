...
namespace Screenshot
{
    public partial class SelectArea : Form
    {
        ...
        {
            e.Graphics.FillRectangle(Brushes.Blue, Top);
            e.Graphics.FillRectangle(Brushes.Blue, Left);
            e.Graphics.FillRectangle(Brushes.Blue, Right);
            e.Graphics.FillRectangle(Brushes.Blue, Bottom);
        }
