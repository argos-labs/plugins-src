...
from argoslabs.microsoft.graph.ms_graph.users import Users
from argoslabs.microsoft.graph.ms_graph.drives import Drives
from argoslabs.microsoft.graph.ms_graph.groups import Groups
from argoslabs.microsoft.graph.ms_graph.notes import Notes
from argoslabs.microsoft.graph.ms_graph.session import GraphSession
from argoslabs.microsoft.graph.ms_graph.drive_items import DriveItems
from argoslabs.microsoft.graph.ms_graph.search import Search
from argoslabs.microsoft.graph.ms_graph.personal_contacts import PersonalContacts
from argoslabs.microsoft.graph.ms_graph.mail import Mail

from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.workbook import Workbooks
from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.range import Range
