...
class DriveItems():
    ...
    # mcchae
    def get_drive_children_by_path(self, drive_id: str, path: str) -> dict:
        """List children under the Drive for item
        ...
        content = self.graph_session.make_request(
            method="get",
            endpoint=self.collections_endpoint + f"/{drive_id}/root:/{path}:/children"
        )
