...
class CalculationTypes(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import CalculationTypes
...
class WorksheetVisibility(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import WorksheetVisibility
...
class RangeShift(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import RangeShift
...
class Underline(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import Underline
...
class VerticalAlignment(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import VerticalAlignment
...
class HorizontalAlignment(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import HorizontalAlignment
...
class BorderStyle(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import BorderStyle
...
class BorderWeight(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import BorderWeight
...
class ApplyTo(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import ApplyTo
        >>> ApplyTo.ALL.value
    """
...
class TableStyle(Enum):
    ...
    ### Usage:
    ----
        >>> from argoslabs.microsoft.graph.ms_graph.workbooks_and_charts.enums import TableStyle
