...
Description
===========
ARGOS LABS Zenity Password Plugin
"""
# Authors
# ===========
#
...
def _main(*args):
    with ModuleContext(
            ...
            output_type='csv',
            display_name='Dialog Password',
            icon_path=get_icon_path(__file__),
            description='Create a password dialog using zenity',
    ) as mcxt:
        # ##################################### for app dependent parameters
        # ##################################### for app optional parameters
        mcxt.add_argument('--username', display_name='Username', default= False,
                          type=bool,
                          help='Display the username option')
        # ----------------------------------------------------------------------
