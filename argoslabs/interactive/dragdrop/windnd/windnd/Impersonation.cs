...
namespace windnd
{
    public class Impersonation
    {
        ...
        public static bool ExecuteAppAsLoggedOnUser(string AppName, string CmdLineArgs, string WorkingDirectory)
        {
            ...
            string trayProcessName = AppName;
            ...
            if (null != explorerProcessList && explorerProcessList.Count > 0)
            {
                foreach (Process explorerProcess in explorerProcessList)
                {
                    ...
                    try
                    {
                        ...
                        uint dwCreationFlags = NORMAL_PRIORITY_CLASS; // | CREATE_NEW_CONSOLE; // CREATE_NO_WINDOW;
                        ...
                        //if (!CreateProcessAsUser(DuplicateToken, string.Empty, //AppName, 
                        //    (CmdLineArgs == null) ? string.Empty : CmdLineArgs, 
                        //    ref processAttributes, ref threadAttributes, true, 
                        //    dwCreationFlags, UserEnvironment,
                        //    WorkingDirectory, ref si, out pi))
                        if (!CreateProcessAsUser(DuplicateToken, null, CmdLineArgs,
