...
from argoslabs.check.env.screeninfo.common import Monitor
...
def enumerate_monitors() -> T.Iterable[Monitor]:
    ...
    # ctypes.windll.user32.ReleaseDC(dc_full)  # mcchae : this cause error
    ctypes.windll.user32.ReleaseDC(0, dc_full)
